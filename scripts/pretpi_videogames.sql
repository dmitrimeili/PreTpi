...
CREATE TABLE `videogames` (
  ...
  `Devloppers_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `Name_UNIQUE` (`name`),
  KEY `fk_VideoGames_Devloppers1_idx` (`Devloppers_id`),
  CONSTRAINT `fk_VideoGames_Devloppers1` FOREIGN KEY (`Devloppers_id`) REFERENCES `devloppers` (`id`)
