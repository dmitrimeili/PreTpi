...
--
-- Table structure for table `videogamecategories`
--

DROP TABLE IF EXISTS `videogamecategories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `videogamecategories` (
...
--
-- Dumping data for table `videogamecategories`
--

LOCK TABLES `videogamecategories` WRITE;
